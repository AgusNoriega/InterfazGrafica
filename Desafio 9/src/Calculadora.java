...
import java.awt.Button;  // en vez de javax.swing.JButton


// ====== CAMPOS (dentro de la clase, fuera de zonas generadas) ======
...
public class Calculadora extends javax.swing.JFrame {
  ...
  private BigDecimal acumulado = BigDecimal.ZERO;   // valor acumulado
private String operadorPendiente = null;          // "+", "-", "×", "÷"
private boolean limpiarEntrada = true;            // limpiar al escribir nuevo número
private StringBuilder entrada = new StringBuilder(); // lo que vas tipeando/armando
...
private void onOperator(String op) {
    // Si no había nada tipeado, usamos lo que ya hay en pantalla
    ...
    // preparar siguiente entrada y guardar operador
    operadorPendiente = op;
    limpiarEntrada = true;
}

/** Realiza la operación con redondeo en división. */
